...
export const MAZINGIRA_RWA_ABI = [
  ...
  // Read
  { type: "function", name: "getProduct",        stateMutability: "view",       inputs: [{ name: "tokenId", type: "uint256" }],               outputs: [{ name: "", type: "tuple", components: [{ name: "id", type: "uint256" }, { name: "vendor", type: "address" }, { name: "metadataURI", type: "string" }, { name: "pricePerUnit", type: "uint256" }, { name: "totalSupply", type: "uint256" }, { name: "available", type: "uint256" }, { name: "category", type: "uint8" }, { name: "co2SavedKgPerUnit", type: "uint256" }, { name: "active", type: "bool" }] }] },
